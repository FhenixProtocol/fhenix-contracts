...
task("task:gt").setAction(async function (taskArguments: TaskArguments, hre) {
  const { ethers, deployments } = hre;

  const { deployer } = await hre.getNamedAccounts();
  const { deploy } = deployments;

  const deployResult = await deploy("Gt", {
    from: deployer,
    args: [],
    log: true,
  ...
  const contract = await ethers.getContractAt("Gt", deployResult.address);
  ...
  const testCases = [
    ...
    {
      function: "gt(euint8,euint16)",
      cases,
    },
    {
      function: "gt(euint8,euint32)",
      cases,
    },
    {
      function: "gt(euint8,uint8)",
      cases,
    },
    {
      function: "gt(uint8,euint8)",
      cases,
    },
    {
      function: "gt(euint16,euint8)",
      cases,
    },
    {
    ...
    {
      function: "gt(euint16,euint32)",
      cases,
    },
    {
      function: "gt(euint16,uint16)",
      cases,
    },
    {
      function: "gt(uint16,euint16)",
      cases,
    },
    {
      function: "gt(euint32,euint8)",
      cases,
    },
    {
      function: "gt(euint32,euint16)",
      cases,
    },
    {
    ...
    {
      function: "gt(euint32,uint32)",
      cases,
    },
    {
      function: "gt(uint32,euint32)",
      cases,
    },
  ];
  ...
  for (const test of testCases) {
    for (const testCase of test.cases) {
      try {
        const encryptedOutput = await contract.connect(signer).gt(testCase.a, testCase.b, test.function, publicKey);
